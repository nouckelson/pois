...
<html>
    ...
    <body>
        ...
        <div id="show-emplacement" class="content scaffold-show" role="main">
            ...
            <f:display bean="emplacement" />
            <g:form resource="${this.emplacement}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.emplacement}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
